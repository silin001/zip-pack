(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('os'), require('tty')) :
    typeof define === 'function' && define.amd ? define(['exports', 'os', 'tty'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ZipPack = {}, global.require$$0, global.require$$1));
    ...
    */
    ...
    /* 判断文件是否存在 */
    const isPathExists = (filePath) => fs$1.existsSync(filePath);
     ...
     * @return {*}
     */
    function dirToZipFun({ enable, optZipName = "dist", targetDir = "dist", }) {
        if (!enable) {
            console.log(sucess(`
      <===========   插件已禁用   ======>
      ${name} 插件版本：${version}
